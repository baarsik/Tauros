...
#define INVALID_OCCLUSION_QUERY_OBJECT_HANDLE ( (OcclusionQueryObjectHandle_t)0 )
	...
	public:
		...
		{
			typedef IMaterial*(__thiscall* OrigFn)(void*, const char*, KeyValues*);
			return CallVFunction<OrigFn>(this, 83)(this, pMaterialName, pVMTKeyValues);
		}
