...
void DrawManager::CreateObjects()
{
    ...
    auto font = _fonts.AddFontFromFileTTF((fontDir + XorStr("gost-a.ttf")).c_str(), FontSize, nullptr, _fonts.GetGlyphRangesCyrillic());

	static const ImWchar icons_ranges[] = { ICON_MIN_FA, ICON_MAX_FA, 0 };
	ImFontConfig icons_config; icons_config.MergeMode = true; icons_config.PixelSnapH = true;
	_fonts.AddFontFromFileTTF((fontDir + XorStr("fontawesome-webfont.ttf")).c_str(), FontSize + 2.0f, &icons_config, icons_ranges);
